# Alunos e DRE:
    # João David Jotta - 121155853
    # Lucas de Lyra Monteiro - 121039714
    # Pedro Poppolino - 119142535

Para rodar o programa, só é necessário chamar o arquivo "calculadora.py" na linha de comando, 
indicando o endereço do arquivo que deseja ler, por exemplo:

python calculadora.py < entrada.txt
